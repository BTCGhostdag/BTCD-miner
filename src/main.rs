...
async fn main() -> Result<(), Error> {
    ...
    let (app, mut plugin_manager): (App, PluginManager) = BTCD_miner::load_plugins(Opt::into_app(), &plugins)?;
    ...
    info!("=================================================================================");
    info!("                 BTCD-miner GPU {}", env!("CARGO_PKG_VERSION"));
